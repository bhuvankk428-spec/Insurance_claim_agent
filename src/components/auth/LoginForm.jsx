      ...
      <div className="w-full lg:w-2/5 flex flex-col justify-center items-center px-4 py-6 sm:px-6 sm:py-8 lg:p-8 bg-black/50 backdrop-blur-sm">
        <div className="bg-neutral-900/90 backdrop-blur-xl rounded-3xl shadow-2xl w-full max-w-md sm:max-w-lg lg:max-w-lg flex flex-col items-center p-4 sm:p-6 lg:p-8 border border-neutral-800/50">
          ...
          <div className="flex justify-center mb-4 sm:mb-6 lg:mb-8">
            <div className="w-14 h-14 sm:w-16 sm:h-16 lg:w-20 lg:h-20 rounded-2xl border-4 border-sky-500/60 bg-gradient-to-br from-sky-900/50 to-violet-900/50 flex items-center justify-center shadow-2xl">
              <img
                src="/logo.png"
                alt="QK.AI Logo"
          ...
          <div className="text-center mb-5 sm:mb-6 lg:mb-8">
            <h1 className="text-2xl sm:text-3xl lg:text-4xl font-black mb-2 bg-gradient-to-r from-sky-400 via-blue-400 to-violet-400 bg-clip-text text-transparent drop-shadow-2xl">
              Welcome Back
            </h1>
